...
_if {return new Symbol(sym._IFDEF, yychar, yyline, yytext());}
_ifdef {return new Symbol(sym._IFDEF, yychar, yyline, yytext());}
_ifnde {return new Symbol(sym.IFNDEF, yychar, yyline, yytext());}
_elif {return new Symbol(sym._ELIF, yychar, yyline, yytext());}
